...
export const makeStyles = <ClassKey extends string, Props extends {}>(styles: StylesFunc<ClassKey, Props> | StyleRules<Props, ClassKey>): ReturnType<typeof muiMakeStyles> => {
